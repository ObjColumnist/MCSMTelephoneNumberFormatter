...
system("svn checkout http://closure-library.googlecode.com/svn/trunk/ #{@build_directory_path}/closure-library")

# Download closure-compiler
system("curl -f -L http://closure-compiler.googlecode.com/files/compiler-latest.zip > #{@build_directory_path}/compiler-latest.zip")
